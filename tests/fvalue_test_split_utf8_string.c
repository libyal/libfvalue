/*
 * Library split_utf8_string type test program
 *
...
/* Tests the libfvalue_split_utf8_string_initialize function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfvalue_split_utf8_string_initialize(
	          &split_string,
	          utf8_string,
	          5,
	          1,
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfvalue_split_utf8_string_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfvalue_split_utf8_string_initialize with memset failing
		 */
	...
	/* 1 memcpy of utf8_string to internal_split_string->string
	 */
	for( test_number = 0;
...
/* Tests the libfvalue_split_utf8_string_free function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libfvalue_split_utf8_string_get_string function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_get_string(
     void )
{
	uint8_t utf8_string[ 5 ] = {
		't', 'e', 's', 't', 0 };
	...
	result = libfvalue_split_utf8_string_get_string(
	          split_string,
	          &string,
	          &string_size,
	          &error );
...
/* Tests the libfvalue_split_utf8_string_get_number_of_segments function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_get_number_of_segments(
     void )
{
	uint8_t utf8_string[ 5 ] = {
		't', 'e', 's', 't', 0 };
	...
	result = libfvalue_split_utf8_string_get_number_of_segments(
	          split_string,
	          &number_of_segments,
	          &error );
...
/* Tests the libfvalue_split_utf8_string_get_segment_by_index function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_get_segment_by_index(
     void )
{
	uint8_t utf8_string[ 5 ] = {
		't', 'e', 's', 't', 0 };
	...
	result = libfvalue_split_utf8_string_set_segment_by_index(
	          split_string,
	          0,
	          ( (libfvalue_internal_split_utf8_string_t *) split_string )->string,
	          5,
	          &error );
	...
	result = libfvalue_split_utf8_string_get_segment_by_index(
	          split_string,
	          0,
	          &string_segment,
	          &string_segment_size,
...
/* Tests the libfvalue_split_utf8_string_set_segment_by_index function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_split_utf8_string_set_segment_by_index(
     void )
{
	uint8_t utf8_string[ 5 ] = {
		't', 'e', 's', 't', 0 };
	...
	result = libfvalue_split_utf8_string_set_segment_by_index(
	          split_string,
	          0,
	          (uint8_t *) ( ( (libfvalue_internal_split_utf8_string_t *) split_string )->string - 10 ),
	          5,
	          &error );
	...
	result = libfvalue_split_utf8_string_set_segment_by_index(
	          split_string,
	          0,
	          (uint8_t *) ( ( (libfvalue_internal_split_utf8_string_t *) split_string )->string + 3 ),
	          5,
	          &error );
...
#endif
{
	...
	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_initialize",
	 fvalue_test_split_utf8_string_initialize );

#endif /* defined( __GNUC__ ) && !defined( LIBFVALUE_DLL_IMPORT ) */

	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_free",
	 fvalue_test_split_utf8_string_free );

#if defined( __GNUC__ ) && !defined( LIBFVALUE_DLL_IMPORT )

	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_get_string",
	 fvalue_test_split_utf8_string_get_string );

	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_get_number_of_segments",
	 fvalue_test_split_utf8_string_get_number_of_segments );

	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_get_segment_by_index",
	 fvalue_test_split_utf8_string_get_segment_by_index );

	FVALUE_TEST_RUN(
	 "libfvalue_split_utf8_string_set_segment_by_index",
	 fvalue_test_split_utf8_string_set_segment_by_index );
