/*
 * Library utf16_string type test program
 *
...
#include "../libfvalue/libfvalue_utf16_string.h"

/* Tests the libfvalue_utf16_string_split function
 * Returns 1 if successful or 0 if not
 */
int fvalue_test_utf16_string_split(
     void )
{
	uint16_t utf16_string1[ 6 ]                  = { '1', '\t', '2', '\t', '3', 0 };
	uint16_t utf16_string2[ 5 ]                  = { '1', '\t', '2', '\t', 0 };
	...
	/* Test regular cases
	 */
	result = libfvalue_utf16_string_split(
	          utf16_string1,
	          6,
	          '\t',
	          &split_string,
...
#endif
{
	...
	FVALUE_TEST_RUN(
	 ...
	 fvalue_test_utf16_string_split );
