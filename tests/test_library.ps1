...
$LibraryTests = "binary_data data_handle error filetime floating_point integer split_utf16_string split_utf8_string string support table value value_entry"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\fvalue_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libfvalue"
